...
class SNN(nn.Module):
    def __init__(self, tau):
        ...
        self.layer = nn.Sequential(
            layer.Flatten(),
            layer.Linear(32 * 32 * 3, 256, bias=False),
...
def main():
    ...
    * :ref:`中文API <lif_fc_mnist.main-cn>`
    ...
    '''
    parser = argparse.ArgumentParser(description='Izhi CIFAR10 Training')
    ...
    parser.add_argument('-data-dir', default='./CIFAR10', type=str, help='root dir of CIFAR10 dataset')
    parser.add_argument('-out-dir', default='./CIFAR10/results', type=str, help='root dir for saving logs and checkpoint')
