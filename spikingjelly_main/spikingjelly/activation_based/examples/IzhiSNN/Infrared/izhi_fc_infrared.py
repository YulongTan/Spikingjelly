...
class SNN(nn.Module):
    def __init__(self, tau):
        ...
        self.layer = nn.Sequential(
            ...
            # neuron.IzhikevichNode(tau=tau, tau_w=tau),

            layer.Linear(36 * 18, 64, bias=False),
            neuron.IzhikevichNode(tau=tau, tau_w=tau),

            layer.Linear(64, 32, bias=False),
            neuron.IzhikevichNode(tau=tau, tau_w=tau),

            layer.Linear(32, 10, bias=False),
            neuron.IzhikevichNode(tau=tau, tau_w=tau),
            )
...
def main():
    ...
    * :ref:`中文API <lif_fc_mnist.main-cn>`
    ...
    parser.add_argument('-data-dir', default='D:/spikingjelly-master/spikingjelly/activation_based/examples/IzhiSNN/Infrared', type=str, help='root dir of MNIST dataset')
